...
"${SCRIPT_DIR}/qt-viewer-rfb-smoke.sh" /tmp/uvnc-qt-viewer-rfb-build "${INSTALL_PREFIX}"
"${SCRIPT_DIR}/qt-viewer-persistent-input-smoke.sh" /tmp/uvnc-qt-viewer-persistent-input-build "${INSTALL_PREFIX}"
