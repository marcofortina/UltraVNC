...
public:
    ...
    bool SendCursorShape(TcpSocket& socket, RfbClientState& state, const CursorShape *shape = nullptr) const;
    bool SendCursorShape(RfbTransport& transport, RfbClientState& state, const CursorShape *shape = nullptr) const;
